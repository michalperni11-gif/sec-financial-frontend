        ...
        {visible.map((day) => {
          ...
          return (
            <div key={day.date} className="group relative flex flex-1 flex-col items-center justify-end h-full">
              ...
              />
              {/* Tooltip */}
              <div className="pointer-events-none absolute bottom-full mb-1.5 left-1/2 -translate-x-1/2 hidden group-hover:flex flex-col items-center z-10">
                <div className="rounded bg-zinc-800 border border-zinc-700 px-2 py-1 text-center shadow-lg whitespace-nowrap">
